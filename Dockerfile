...
#ENTRYPOINT ["java","-cp","app:app/lib/*","com.mempoolexplorer.configuration.server.ConfigurationServerApplication"]

#Opcion funciona mio
COPY ${DEPENDENCY} /
ENTRYPOINT ["java", "-jar", "/app/configurationServer-0.0.1-SNAPSHOT.jar"]
